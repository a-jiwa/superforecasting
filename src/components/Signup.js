...
import closeIcon from '../icons/close-button.svg'; // Adjust the path to where your SVG is located
import showPasswordIcon from '../icons/show-password.svg'; // Adjust the path as needed
import hidePasswordIcon from '../icons/hide-password.svg'; // Adjust the path as needed
